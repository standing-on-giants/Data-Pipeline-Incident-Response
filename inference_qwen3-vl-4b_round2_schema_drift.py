"""
inference_qwen3-vl-4b_round2_schema_drift.py — Data Pipeline Agent (Round 2 Schema Drift)
====================================================================================
Uses Qwen3-VL 4B via the standard OpenAI Python SDK using the local Ollama endpoint.
...
# Point OpenAI client to local Ollama endpoint
API_BASE_URL   = "http://localhost:11434/v1"
API_KEY        = "ollama"  # local Ollama doesn't require a real key
MODEL_NAME     = os.getenv("MODEL_NAME") or "qwen3-vl:4b"
...
def main():
    ...
    # Initialise the OpenAI client pointing to local Ollama API
    client = OpenAI(
